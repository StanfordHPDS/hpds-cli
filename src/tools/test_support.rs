...
//! formats the real releases ship in, plus a race-free writer for
//! executable shim scripts that tests spawn.
...
pub(crate) fn write_executable_shim(path: &std::path::Path, contents: impl AsRef<[u8]>) {
